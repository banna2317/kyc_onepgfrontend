...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/rc-engine", {

            engine_no: engine_no.value,
...
async function getrecords() {
    try {
        ...
        const response = await axios.post("/rc-engine-records");
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/rc-engine-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Engine To RC Verification</h1>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allRecords" :key="record.id" class="hover:bg-muted/50">
                                        ...
                                        <TableCell class="font-mono">{{ record.engine_no }}</TableCell>
        ...
        <Dialog :open="isDialogOpen" @update:open="val => isDialogOpen = val">
            <DialogContent class="sm:max-w-md">
                <DialogHeader>
                    <DialogTitle>Verify Engine Number</DialogTitle>
                </DialogHeader>
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        ...
                        <Input id="engine" placeholder="Engine Number" v-model="engine_no" />
                    </div>

                    <div class="flex justify-end gap-3 pt-4">
                        <Button @click="handleVerify" :disabled="!engine_no" class="bg-purple-600 hover:bg-purple-700">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col border-b p-2">
                            ...
                            <span class="font-mono">{{ selectedRecord.engine_no }}</span>
                        </div>
                        <div class="flex flex-col border-b p-2">
