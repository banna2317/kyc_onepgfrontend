...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/rc-mobile", {
...
async function getrecords() {
    try {
        ...
        const response = await axios.post("/rc-mobile-records");
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/rc-mobile-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">RC With Mobile Verification</h1>
            ...
            <DialogContent  class="sm:max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Total Details</span>
