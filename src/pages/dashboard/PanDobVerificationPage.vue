...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/pan-dob", {
        ...
        toast({
            title: "Success",
            description: response.data.message || "Pancard verification successful2.",
        });
...
async function getrecords(page = 1) {
    try {
        ...
        const response = await axios.post(`/pan-dob-records?page=${page}`, {
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/pan-dob-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Pancard With DOB Verification</h1>

                <div class="flex flex-col sm:flex-row sm:items-center gap-1 mt-2">
                    <p class="text-sm sm:text-base text-muted-foreground">
                        Verify Pancard with dob.   <Button variant="link" class="p-0 h-auto text-blue-600 hover:text-blue-800">
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allRecords" :key="record.id" class="hover:bg-muted/50">
                                        ...
                                        <TableCell class="font-mono">{{ record.full_name }}</TableCell>
                                        <TableCell class="font-mono">{{ record.category }}</TableCell>
            ...
            <DialogContent class="sm:max-w-lg">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div v-if="selectedRecord.full_name"
                            class="flex justify-between items-center py-2 border-b border-border/50">
                        ...
                        <div v-if="selectedRecord.category"
                            class="flex justify-between items-center py-2 border-b border-border/50">
                        ...
                        <div v-if="selectedRecord.gender"
                            class="flex justify-between items-center py-2 border-b border-border/50">
