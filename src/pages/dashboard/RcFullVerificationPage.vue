...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/rc-full", {
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/rc-full-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">RC Book Full Verification</h1>
            ...
            <DialogContent class="sm:max-w-lg max-h-[90vh] overflow-y-auto">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-2 gap-4">
                        ...
                        <!-- client_id -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Client ID</span>
                            <span class="font-mono">{{ selectedRecord.client_id }}</span>
                        </div>
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Chassis Number</span>
                            <span class="font-mono">{{ selectedRecord.vehicle_chasi_number }}</span>
                        </div>

                        <!-- vehicle_engine_number -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Engine Number</span>
                        ...
                        <!-- fit_up_to -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Fitness Upto</span>
                        ...
                        <div class="flex flex-col border-b p-2">
                            ...
                            <span class="font-mono">{{ selectedRecord.financed }}</span>
                        </div>
                        ...
                        <div class="flex flex-col border-b p-2">
                            ...
                            <span class="font-mono">{{ selectedRecord.less_info }}</span>
                        </div>
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Gross Weight</span>
                            <span class="font-mono">{{ selectedRecord.vehicle_gross_weight }}</span>
                        </div>

                        <!-- no_cylinders -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">No. of Cylinders</span>
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Category Description</span>
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">National Permit No.</span>
                        ...
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">NP Issued By</span>
                        ...
                        <div class="flex flex-col border-b p-2">
                            ...
                            <span class="font-mono">{{ selectedRecord.non_use_status }}</span>
                        </div>
                        ...
                        <div class="flex flex-col border-b p-2">
                            ...
                            <span class="font-mono">{{ selectedRecord.blacklist_status }}</span>
                        </div>

                        <!-- noc_details -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">NOC Details</span>
                        ...
                        <!-- challan_details -->
                        <div class="flex flex-col border-b p-2">
                            <span class="text-muted-foreground font-medium">Challan Details</span>

                            <template v-if="selectedRecord.challan_details">
                                <div class="font-mono">
                                    <div>Total Challans: {{ JSON.parse(selectedRecord.challan_details).total_challans }}
                                    </div>
                                    <div>Amount: {{ JSON.parse(selectedRecord.challan_details).amount }}</div>
                                </div>
                            </template>
                        </div>
