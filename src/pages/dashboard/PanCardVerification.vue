...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/pan-verification", {
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/pan-verification-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Pancard Verification</h1>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allRecords" :key="record.id" class="hover:bg-muted/50">
                                        ...
                                        <TableCell class="font-mono">{{ record.is_valid }}</TableCell>
