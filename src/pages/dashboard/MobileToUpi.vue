...
async function getrecords(page = 1) {
    try {
        const response = await axios.post(`/bank-mobile-to-upi-records?page=${page}`, {
...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/bank-mobile-to-upi", {
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/bank-mobile-to-upi-recordID", { id: id });
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allupiRecords" :key="record.id"
                                        ...
                                        <TableCell class="font-mono">{{ record.verification_id }}</TableCell>
