...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/pan-aadhar-link", {
        ...
        toast({
            title: "Success",
            description: response.data.message || "Pancard verification initiated successfully.",
        });
...
async function getrecords(page = 1) {
    try {
        ...
        const response = await axios.post(`/pan-aadhar-link-records?page=${page}`);
...
async function handleViewRecord(id) {
    try {
        ...
        const response = await axios.post("/pan-aadhar-link-recordID", { id: id });
            ...
            <div>
                ...
                <div class="flex flex-col sm:flex-row sm:items-center gap-1 mt-2">
                    <p class="text-sm sm:text-base text-muted-foreground">
                        Verify Pancard Lite. <Button variant="link"
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allRecords" :key="record.id" class="hover:bg-muted/50">
                                        ...
                                        <TableCell class="font-mono">{{ record.is_linked ?? "N/A" }}</TableCell>
        ...
        <Dialog :open="isDialogOpen" @update:open="val => isDialogOpen = val">
            <DialogContent class="sm:max-w-md">
                ...
                <div class="space-y-4">
                    ...
                    <div class="space-y-2">
                        <div class="flex items-center gap-2">
                            <Label for="aadhar">Aadharcard Number</Label>

                        </div>
                        <Input id="aadhar" placeholder="Enter aadhar Number" v-model="aadhaar_number" />
                    </div>
            ...
            <DialogContent class="sm:max-w-lg">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-border/50">
                            <span class="text-muted-foreground font-medium">AADHAR NUMBER</span>
                            <span class="font-mono">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-border/50">
                            <span class="text-muted-foreground font-medium">Linked</span>
                            <span class="font-medium">
                                {{ selectedRecord.is_linked }}
                            </span>
                        </div>
                        <div class="flex justify-between items-center py-2 border-b border-border/50">
