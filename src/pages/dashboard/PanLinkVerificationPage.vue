...
async function handleVerify() {
    ...
    try {
        const response = await axios.post("/pan-link", {
...
async function getrecords() {
    try {
        ...
        const response = await axios.post("/pan-link-records");
...
async function handleViewRecord(id) {
    ...
    try {
        ...
        const response = await axios.post("/pan-link-recordID", { id: id });
...
<template>
    <div class="space-y-6">
        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-3 md:gap-0">
            <div>
                <h1 class="text-xl sm:text-2xl lg:text-3xl font-bold tracking-tight">Pancard Link Verification</h1>
                            ...
                            <Table>
                                ...
                                <TableBody>
                                    <TableRow v-for="record in allRecords" :key="record.id" class="hover:bg-muted/50">
                                        ...
                                        <TableCell class="font-mono">{{ record.is_linked }}</TableCell>
            ...
            <DialogContent class="sm:max-w-md">
                ...
                <div class="space-y-4">
                    ...
                    <div class="flex justify-end gap-3 pt-4">
                        <Button @click="handleVerify" :disabled="!pancard_number" class="bg-purple-600 hover:bg-purple-700">
            ...
            <DialogContent class="sm:max-w-lg">
                ...
                <div v-if="selectedRecord" class="space-y-4">
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <div class="flex justify-between items-center py-2 border-b border-border/50">
                            <span class="text-muted-foreground font-medium">is Valid</span>
                            <span class="font-mono">
